...
func TestNoMFADecision(t *testing.T) {
	setup([]string{"cmd", "--mode=validate_offline", "--template=some_path" })
	assert.Equal(t, (*bool)(nil), configuration.DefaultDecisionForMFA)
}
...
func TestNoDurationForMFA(t *testing.T) {
	setup([]string{"cmd", "--mode=validate_offline", "--template=some_path" })
	assert.Equal(t, (*int64)(nil), configuration.DefaultDurationForMFA)
}
...
func TestZeroDurationForMFA(t *testing.T) {
	setup([]string{"cmd", "--mode=validate_offline", "--template=some_path", "--duration=0"})
	assert.Equal(t, (*int64)(nil), configuration.DefaultDurationForMFA)
}
